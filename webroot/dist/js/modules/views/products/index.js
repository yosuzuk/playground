...
/***/ function(module, exports, __webpack_require__) {
	...
	var _productSourceAMD = __webpack_require__(301);

	var productSource = _interopRequireWildcard(_productSourceAMD);

	var _static = __webpack_require__(302);
	...
	(0, _jquery2.default)('<div></div>').html(_static2.default).appendTo('body'); // written in AMD!


	var products = productSource.getProducts();
	...
	try {
	    for (var _iterator = products[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        ...
	        (0, _jquery2.default)('<li></li>').text(product).appendTo(ul);
	    }
	} catch (err) {
